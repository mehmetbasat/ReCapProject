...
namespace Business.Concrete
{
    public class RentalManager : IRentalService
    {
        ...
        {
            return new SuccessDataResult<Rental>(_rentalDal.GetById(r => r.Id == rentalId), Messages.RentalListed);
        }
        ...
        public IResult Delete(int rentalId)
        {
            ...
            var deletedRental = _rentalDal.GetById(r => r.Id == rentalId);
        ...
        {
            return new SuccessDataResult<DateTime>(_rentalDal.GetById(r => r.CarId == carId && r.RentDate <= DateTime.Now && r.ReturnDate >= DateTime.Now && r.DeliveryStatus == false).ReturnDate);
        }
